...
from src.models.auto_encoder_utils import AutoEncoderModel, fit_with_early_stopping, predict_test_scores
...
class AutoEncoder(Algorithm, PyTorchUtils):
    ...
    def fit(self, train_data : np.array, categorical_columns=None):
        ...
        self.model = AutoEncoderModel(train_data.shape[-1], self.hidden_size, seed=self.seed, gpu=self.gpu)
