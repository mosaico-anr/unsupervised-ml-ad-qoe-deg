...
def contamination_experiment(model_name, save_dir, data_dir, n_runs=5, window_size=10, cont_rate=0, threshold=10, verbose=False, is_trained=False, is_consecutive=False):
...
def run_all_experiments(args):
    ...
    # import sys
    #sys.exit()
    # contamination_rate = [0, 0.02, 0.04, 0.06, 0.08, 0.1, 0.12]
    ...
    for model_name in models_list:
        ...
        contamination_experiment(model_name=model_name, save_dir=win_save_path, data_dir=data_dir, n_runs=n_runs, 
